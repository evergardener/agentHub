...
ALTER TABLE agent_profiles ADD COLUMN allowed_models_json TEXT NOT NULL DEFAULT '[]';
ALTER TABLE agent_profiles ADD COLUMN reasoning_effort TEXT;
ALTER TABLE agent_profiles ADD COLUMN allowed_reasoning_efforts_json TEXT NOT NULL DEFAULT '[]';
